...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url() ?>assets/img/hms.png" />
    <link rel="icon" type="image/png" href="<?= base_url() ?>assets/img/hms.png" />
    ...
    <meta itemprop="image" content="<?= base_url() ?><?= base_url() ?><?= base_url() ?>s3.amazonaws.com/creativetim_bucket/products/51/opt_mdp_thumbnail.jpg">
    <!-- Twitter Card data -->
    ...
    <meta name="twitter:image" content="<?= base_url() ?><?= base_url() ?><?= base_url() ?>s3.amazonaws.com/creativetim_bucket/products/51/opt_mdp_thumbnail.jpg">
    <!-- Open Graph data -->
    <meta property="fb:app_id" content="655968634437471">
    <meta property="og:title" content="Material Dashboard PRO by Creative Tim | Premium Bootstrap Admin Template" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="http://www.creative-tim.com/product/material-dashboard-pro" />
    <meta property="og:image" content="<?= base_url() ?><?= base_url() ?><?= base_url() ?>s3.amazonaws.com/creativetim_bucket/products/51/opt_mdp_thumbnail.jpg" />
...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar" data-active-color="rose" data-background-color="black" data-image="<?= base_url() ?>assets/img/sidebar-3.jpg">
            <div class="logo">
                <a href="<?= site_url('admin/dashboard') ?>" class="simple-text">
                    Harum Manis Logistik
                </a>
            </div>
            <div class="logo logo-mini">
                <div class="simple-text logo-mini">
                    <img src="<?= base_url() ?>assets/img/hms.png" class="logo-mini" width="55px">
                </div>
            </div>
            <div class="sidebar-wrapper">
                <div class="user">
                    <div class="photo">
                        <img src="<?= base_url() ?>uploads/user-image/<?= $this->fungsi->user_login()->image; ?>" />
                    </div>
                    <div class="info">
